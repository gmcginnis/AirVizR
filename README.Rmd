...
```{r example_map_stad, warning = FALSE, message = FALSE, fig.retina=2, echo = FALSE}
...
```{r example_heatmap_single, warning = FALSE, message = FALSE, fig.height = 7, echo = FALSE}
...
```{r example_heatmap_cross, warning = FALSE, message = FALSE, fid.width=10, fig.height = 7, echo = FALSE}
...
```{r example_ts_line, warning = FALSE, message = FALSE, fig.retina=2, echo = FALSE}
...
```{r comp, message = FALSE, warning = FALSE, echo = FALSE, fig.height = 8}
library(ggplot2)
library(magrittr)
