...
```{r example_map_stad, warning = FALSE, message = FALSE}
...
```{r example_heatmap_single, warning = FALSE, message = FALSE, fig.height=8}
...
```{r example_heatmap_cross, warning = FALSE, message = FALSE, fid.width=8}
