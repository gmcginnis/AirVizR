...
#' @examples 
#' tagged_data <- apply_date_tags(july_api_daily, starts = c("2021-07-01", "2021-07-04", "2021-07-05"), ends = c("2021-07-03", "2021-07-04", "2021-07-07"), tags = c("Before", "Independence Day", "After"))
#' @export
